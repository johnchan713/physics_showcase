/**
 * Phase 5 Validation: actuarial
 *
 * Module: maths/actuarial_life_tables.hpp
 * Functions tested: 0
 */
...
#include <complex>
#include <string>
#include "../include/maths/actuarial_life_tables.hpp"
...
int main() {
    ...
    std::cout << "=== Phase 5: actuarial Validation ===" << std::endl;
    std::cout << "Testing 0 functions from maths/actuarial_life_tables.hpp" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "======================================" << std::endl;
    std::cout << "Phase 5 Results: actuarial" << std::endl;
    std::cout << "======================================" << std::endl;
