/**
 * Phase 5 Validation: nonsmooth
 *
 * Module: maths/nonsmooth_algorithms.hpp
 * Functions tested: 0
 */
...
#include <complex>
#include <string>
#include "../include/maths/nonsmooth_algorithms.hpp"
...
int main() {
    ...
    std::cout << "=== Phase 5: nonsmooth Validation ===" << std::endl;
    std::cout << "Testing 0 functions from maths/nonsmooth_algorithms.hpp" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "======================================" << std::endl;
    std::cout << "Phase 5 Results: nonsmooth" << std::endl;
    std::cout << "======================================" << std::endl;
